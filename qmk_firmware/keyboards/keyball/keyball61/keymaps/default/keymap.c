...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_LGUI  , KC_DEL, KC_LALT ,LT(4, KC_DEL),LT(2,KC_SPC),LT(3, KC_TAB),             KC_BSPC,  LT(2,KC_ENT),LT(3,KC_LNG2),KC_RGUI, _______ , KC_DEL  , KC_PSCR
  ),
  [1] = LAYOUT_universal(
  ...
  [2] = LAYOUT_universal(
    ...
    _______ , KC_PMNS  , KC_P7    , S(KC_BSLS)    , KC_BSLS     , _______  ,                                  _______  , KC_LEFT  , KC_UP    , KC_RGHT  , _______  , KC_F12   ,
    _______ , KC_HOME  , KC_END     , KC_MINS     , KC_EQL   ,_______,                             KC_PGUP  , KC_BTN1  , KC_DOWN  , KC_BTN2  , KC_BTN3  , _______  ,
    _______  , KC_PPLS  , KC_CUT     , KC_COPY     , KC_PASTE  , _______   , KC_QUOT  ,          KC_DQT, KC_PGDN  ,  KC_HOME  ,KC_END   , KC_PGUP  , KC_PGDN ,  _______  ,
    _______  , KC_PAST  , KC_DOT     , KC_0   , _______  , KC_UP  , _______  ,               KC_BSPC  ,  KC_DEL   , _______  , _______  , _______  , KC_DEL  , _______
  ),
  [3] = LAYOUT_universal(
    KC_GRV  , KC_F1    , KC_F2    , KC_F3    , KC_F4     , KC_F5    ,                                     KC_F6    ,    KC_F7  , KC_F8    , KC_F9 , KC_F10   , KC_NUM   ,
    _______  , KC_F11  , KC_F12  , _______  , _______  , _______  ,                                     _______   ,  KC_P7    , KC_P8    , KC_P9  ,KC_PMNS  , KC_CALC,
    _______ , _______  , _______  , _______  , _______  , _______  ,                                  KC_DOT    ,  KC_P4     , KC_P5   , KC_P6  ,KC_PSLS  ,_______,
    _______  , _______  , _______ , _______ , _______  , _______  , _______   ,              _______   , KC_0  ,  KC_P1     , KC_P2   , KC_P3  ,KC_PPLS  ,_______,
    _______  , _______  , _______  , _______  , _______    , _______  , _______  ,              KC_BSPC  , KC_DEL    ,  KC_DOT     , KC_0   , KC_DEL ,KC_PAST  ,_______
  ),
  [4] = LAYOUT_universal(
