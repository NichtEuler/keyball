...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    _______ , KC_PMNS  , KC_P7    , KC_P8    , KC_P9     , KC_BSLS  ,                                  _______  , KC_LEFT  , KC_UP    , KC_RGHT  , _______  , KC_F12   ,
    _______ , KC_HOME  , KC_END     , KC_MINS     , KC_EQL   , S(KC_SCLN);:,                             KC_PGUP  , KC_BTN1  , KC_DOWN  , KC_BTN2  , KC_BTN3  , _______  ,
    _______  , KC_PPLS  , KC_CUT     , KC_COPY     , KC_PASTE  , KC_BSLS   , KC_QUOT  ,          KC_DQT, KC_PGDN  ,  KC_HOME  ,KC_END   , KC_PGUP  , KC_PGDN ,  _______  ,
    _______  , KC_PAST  , KC_DOT     , KC_0   , _______  , KC_UP  , _______  ,               KC_BSPC  ,  KC_DEL   , _______  , _______  , _______  , KC_DEL  , _______
  ),
  [3] = LAYOUT_universal(
    KC_GRV  , KC_F1    , KC_F2    , KC_F3    , KC_F4     , KC_F5    ,                                     KC_F6    ,    KC_F7  , KC_F8    , KC_F9 , KC_F10   , _______   ,
    _______  , KC_F11  , KC_F12  , RGB_VAI  , _______  , SSNP_VRT  ,                                     _______   ,  KC_P7    , KC_P8    , KC_P9  ,KC_PMNS  , _______,
    RGB_RMOD , RGB_HUD  , RGB_SAD  , RGB_VAD  , _______  , SSNP_HOR  ,                                  _______    ,  KC_P4     , KC_P5   , KC_P6  ,KC_PSLS  ,_______,
    _______  , _______  , SCRL_DVD , SCRL_DVI , SCRL_MO  , SCRL_TO  , EE_CLR   ,              _______   , KC_MPLY  ,  KC_P1     , KC_P2   , KC_P3  ,KC_PPLS  ,_______,
    QK_BOOT  , _______  , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , _______  ,              KC_BSPC  , KC_DEL    ,  KC_DOT     , KC_0   , KC_DEL ,KC_PAST  ,_______
  ),
  [4] = LAYOUT_universal(
